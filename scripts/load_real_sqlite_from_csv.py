"""Load user-supplied clinical CSV files into a local SQLite database.
...
from ehr_fhir_genomics_toolkit.io_safety import safe_unlink
...
def main(argv: list[str] | None = None):
    ...
    if out.exists():
        safe_unlink(out, allowed_roots=[Path("data").resolve()])
