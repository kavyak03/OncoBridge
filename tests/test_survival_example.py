from ehr_fhir_genomics_toolkit.demo_data import generate_demo_clinical_cohort, generate_demo_expression_long, generate_demo_variants
...
def test_survival_workflow_runs():
    ...
    mut_flags = summarize_mutations_presence(generate_demo_variants(clinical["sample_id"].tolist(), seed=7), ["TP53","RB1","MYC"])
